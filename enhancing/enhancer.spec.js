...
describe("enhancment unit tests", () => {
    ...
    it("gets", () => {
        expect(enhancer.get({name:"Sword", enhancement: 0, durability: 100}))
            .toMatchObject({name:"Sword", enhancement: 0, durability: 100})
        expect(enhancer.get({name:"Sword", enhancement: 1, durability: 100}))
            .toMatchObject({name:"[+1] Sword", enhancement: 1, durability: 100})
        expect(enhancer.get({name:"Sword", enhancement: 10, durability: 100}))
            .toMatchObject({name:"[+10] Sword", enhancement: 10, durability: 100})
        expect(enhancer.get({name:"Sword", enhancement: 20, durability: 100}))
            .toMatchObject({name:"[+20] Sword", enhancement: 20, durability: 100})
        expect(() => enhancer.get({name:"Sword", enhancement: 21, durability: 100}))
            .toThrow()
        expect(() => enhancer.get({name:"Sword", durability: 100}))
            .toThrow()
        expect(() => enhancer.get({name:"", enhancement: 0, durability: 100}))
            .toThrow()
        expect(() => enhancer.get({name:"Sword", enhancement: 0}))
            .toThrow()
    })
})
